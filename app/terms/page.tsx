...
export const metadata: Metadata = {
  title: 'Terms and Conditions - MHCloth',
  description: 'Terms and conditions for MHCloth. Read our legal terms, conditions of use, and policies governing your use of our services.',
  keywords: 'terms and conditions, legal, policy, MHCloth, Bangladesh company',
}
        ...
        <div className="space-y-8">
          ...
          <Card>
            ...
            <CardContent className="prose max-w-none">
              <p className="text-gray-700 leading-relaxed">
                These terms and conditions apply to the website operated by <strong>MHCloth</strong>, 
                a company based in Bangladesh.
              </p>
              <div className="bg-gray-50 p-4 rounded-lg mt-4">
                <h3 className="font-semibold text-gray-900 mb-2">Company Details:</h3>
                <ul className="space-y-1 text-gray-700">
                  <li><strong>Company Name:</strong> MHCloth</li>
                  <li><strong>Address:</strong> Uttara - Dhaka, Bangladesh</li>
                  <li><strong>Email:</strong> hello@mhcloth.com</li>
          ...
          <Card>
            ...
            <CardContent className="prose max-w-none">
              <p className="text-gray-700 leading-relaxed mb-4">
                Permission is granted to temporarily download one copy of the materials on MHCloth's website 
          ...
          <Card>
            ...
            <CardContent className="prose max-w-none">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                <li>All prices are displayed in Bangladeshi Taka (BDT) and include applicable taxes</li>
          ...
          <Card>
            <CardHeader>
              <h2 className="text-2xl font-bold text-gray-900">5. Consumer Rights</h2>
            </CardHeader>
            <CardContent className="prose max-w-none">
              <p className="text-gray-700 leading-relaxed mb-4">
                Under Bangladesh consumer protection laws, you have the right to:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
          ...
          <Card>
            ...
            <CardContent className="prose max-w-none">
              <p className="text-gray-700 leading-relaxed mb-4">
                In no event shall MHCloth or its suppliers be liable for any damages 
                (including, without limitation, damages for loss of data or profit, or due to business interruption) 
                arising out of the use or inability to use the materials on MHCloth's website.
              </p>
              <p className="text-gray-700 leading-relaxed">
                This limitation applies even if MHCloth or an authorized representative has been 
          ...
          <Card>
            ...
            <CardContent className="prose max-w-none">
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                Bangladesh data protection laws and international best practices.
              </p>
              <p className="text-gray-700 leading-relaxed">
          ...
          <Card>
            ...
            <CardContent className="prose max-w-none">
              <p className="text-gray-700 leading-relaxed">
                ...
                Any disputes relating to these terms and conditions will be subject to the exclusive jurisdiction of the courts of Bangladesh.
              </p>
            </CardContent>
          </Card>
            ...
            <CardContent className="prose max-w-none">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <ul className="space-y-2 text-gray-700">
                  <li><strong>Email:</strong> legal@mhcloth.com</li>
                  <li><strong>Phone:</strong> 01648911447</li>
                  <li><strong>Address:</strong> Uttara - Dhaka, Bangladesh</li>
                </ul>
              </div>
