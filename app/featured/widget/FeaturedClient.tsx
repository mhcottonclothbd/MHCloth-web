  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center text-white">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <div className="flex items-center justify-center gap-3 mb-3">
              ...
              <h1 className="text-4xl md:text-5xl font-bold">Featured Products</h1>
              <Star className="h-6 w-6" />
            </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
              <div className="flex-1">
                <div className="relative">
                  ...
                  <Input value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} placeholder="Search featured products..." className="pl-9" />
                </div>
              </div>
        ...
        {/* Products */}
        <ProductGrid
          filters={{ status: "active", is_featured: true, sort_by: derived.sort_by || "newest", category: derived.category, search: derived.search }}
          showWishlist
          showAddToCart
        />
      </div>
